...
class UpdateHomePageRequest extends FormRequest
{
    ...
    {
        $jsonFields = ['expertise_cards', 'achievements', 'volunteering_bullets', 'social_links', 'skills', 'languages', 'certifications', 'experiences', 'media_appearances', 'honors', 'statistics'];
